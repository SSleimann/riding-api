...
from django.db.models.fields import EmailField, BooleanField, UUIDField
...
class User(AbstractUser):
    ...
    def __str__(self) -> str:
        return "<User: {username}. {email}. {id}>".format(username=self.username, email=self.email, id=self.id)
