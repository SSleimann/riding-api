...
class VehiclesCreationApiView(APIView):
    ...
    def post(self, request):
        ...
        return Response(
            data=VehiclesSerializer(vehicle).data, status=status.HTTP_201_CREATED
        )
...
class VehiclesListApiView(APIView):
    ...
    @extend_schema(responses={200: VehiclesSerializer}, description="Get vehicles info")
...
class VehiclesDeleteApiView(APIView):
    ...
    @extend_schema(responses={204: None}, description="Delete vehicle by id")
...
class VehiclesDetailApiView(APIView):
    ...
    @extend_schema(responses={200: VehiclesSerializer}, description="Get vehicle by id")
